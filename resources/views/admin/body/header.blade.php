    ...
    <nav class="navbar navbar-static-top navbar-expand-lg">
        ...
        <div class="navbar-right ">
            <ul class="nav navbar-nav">
                ...
                <!-- Collect dynamic user data form database -->
                @php
                $id = Auth::user()->id;
                ...
                <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <img src="{{(!empty($adminData -> profile_img)? url('upload/admin_images/'.$adminData->profile_img) : url('upload/profile.png') )}}" class="user-image" alt="User Image" />
                        <span class="d-none d-lg-inline-block">{{$adminData->name}}</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                        <!-- User image -->
                        <li class="dropdown-header">
                            <img src="{{(!empty($adminData -> profile_img)? url('upload/admin_images/'.$adminData->profile_img) : url('upload/profile.png') )}}" class="img-circle" alt="User Image" />
